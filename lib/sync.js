(function() {
	 ...
	 *
	 * Both `then` and `sync` can accept callbacks with a single parameter, and
	 * will pass those callbacks a function, which can be called to indicate
	 * completion - allowing manual management of completion for more complex
	 * use cases.
	 *
	 * Examples:
	 *
